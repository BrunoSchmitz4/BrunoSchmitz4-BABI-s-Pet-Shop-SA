...
<html>
    ...
    <main class="conteudo">
        ...
        <section class="conteudo_secundario">
            ...
            <img width="450px" height="250" src="../css/imgs/1/img_banho.png" alt="Imagem do serviço: banho" class="conteudo_secundario_paragrafo_img"> <!--Tag de imagem que define largura e altura, busca no banco e dá um nome a ela, além de definir uma classe-->
