        ...
        <table class="table_users table-bordere-dark"> <!--Tabela HTML-->
            ...
            <?php
                while($row_user_a = $result_users_a->fetch(PDO::FETCH_ASSOC)){ // outro método extração
                    ...
                    }"</tr>"; // Cria botões de exclusão e modificação (ainda não estão prontos!!)
                    echo "<td class='table_content'><a class='table_linkbt' href='' id='$id'>Excluir</a></td>";
                    echo "<td class='table_content'><a class='table_linkbt' href='' id='$id'>Editar</a></td>";   
