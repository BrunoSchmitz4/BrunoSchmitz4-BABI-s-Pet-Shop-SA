    ...
    <main class="conteudo">
        <section class="conteudo_principal">
            <div class="conteudo_principal_escrito">
                <h1 class="conteudo_principal_escrito_titulo">Contato</h1>
                <h2 class="conteudo_principal_escrito_subtitulo">Contate-nos em caso de dúvidas!</h2>
            </div>
            <div class="list_contatos">
                <ul class="list_main">
                    <li><address><a href="bruno_schmitz-silva@estudante.sesisenai.org.br" class="list_cont_main">Bruno Schmitz da Silva</a></address></li>
                    <br>
                    <li><address><a href="beatriz_gamba@estudante.sesisenai.org.br" class="list_cont_main">Beatriz Riscarolli Gamba</a></address></li>
                    <br>
                    <li><address><a href="arthur_a_lima@estudante.sesisenai.org.br" class="list_cont_main">Arthur Augusto Dias Alves de Lima</a></address></li>
                    <br>
                    <li><address><a href="iasmin_amorim@estudante.sc.senai.br" class="list_cont_main">Iasmin Westphal</a></address></li>
                </ul>
            </div>
        ...
        <div class="text">
                <p>
                    Onde você pode nos encontrar fisicamente?
                    <address>
