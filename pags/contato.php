...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="cabecalho_menu">
            ...
            <a class="cabecalho_menu_item" href="clientelogged.php">Voltar</a>
        ...
        <section class="conteudo_principal">
            ...
            <div class="list_contatos">
                <ul class="list_main"> <!--Cria lista-->
                    <li><address><a href="https://mail.google.com/mail/u/2/#inbox?compose=CllgCJfnbRXNXgBhWnRqJFWGCXwBMwszXqLfJjxMLrPCgCVNqndjqRLJbJHJGSHtWDmCQbpdgNB" class="list_cont_main">Arthur Augusto Dias Alves de Lima</a></address></li> <!--Item da lista e tag de endereço-->
                    <br>
                    ...
                    <br>
                    <li><address><a href="https://mail.google.com/mail/u/2/#inbox?compose=CllgCJfnbRXNXgBhWnRqJFWGCXwBMwszXqLfJjxMLrPCgCVNqndjqRLJbJHJGSHtWDmCQbpdgNB" class="list_cont_main">Bruno Schmitz da Silva</a></address></li>
                    <br>
