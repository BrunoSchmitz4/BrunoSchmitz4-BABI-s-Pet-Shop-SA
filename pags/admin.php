...
// adicionar
// $query_prst_serv = "SELECT id, servico_id, pet_id, usuario_id, preco_id FROM servicos_prestados ORDER BY id ASC";
    ...
    <div>
        <header class="cabecalho">
            ...
            <nav class="cabecalho_menu"> 
                ...
                <a class="cabecalho_menu_item" href="cliente_loggout.php">Sair</a>
            </nav>
        </header>
         ...
         <div class="paineis"> <!--DIV 1-->
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                        ...
                        <div class="form-field">
                            <label>Serviço:</label>
                            <input type="text" name="servico" class='mod1_ta' required><br><br>   
                        </div>
                            
                        <div class="form-field">
                            <p for="input-name" id="label-name">Sobre:</p>
                            <textarea class='mod1_ta' rows='5' cols="25" labelledby="label-name" id="input-name" style="resize: none" name="descricao" placeholder="Descreva o serviço..." required></textarea><br><br><br>
                        </div>
                ...
                while($row_user_b = $result_users_b->fetch(PDO::FETCH_ASSOC)){ // outro método extração
                    ...
                    "<tr>
                        ...
                        if(!empty($modified)){
                            ...
                            "<td class='table_content'>Sem modificação</td>";
                        };

                        echo 
                        "<td class='table_content'><a href=../edita/edita_user.php?id=$id>
                        <button type = 'button' class= 'btn btn-sm btn-success'>Editar</button></a></td>";

                        echo "<td class='table_content'><a href='../deleta/deleta_user.php?id=".$id."'data-confirm='tem certeza que deseha apagar?'><button type = 'button'  class= 'btn btn-sm btn-danger'>Excluir</button></a></td></tr>"; 
                }
            ?>
                            ...
                            <?php
                                ...
                                while($row_pets_b = $result_pets_b->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    "<tr>
                                        ...
                                        echo 
                                        "<td class='table_content'><a href=../edita/edita_pet.php?id=$id>
                                        <button type = 'button' class= 'btn btn-sm btn-success'>Editar</button></a></td>";
                
                                        echo "<td class='table_content'><a href='../deleta/deleta_pet.php?id=".$id."'data-confirm='tem certeza que deseha apagar?'><button type = 'button'  class= 'btn btn-sm btn-danger'>Excluir</button></a></td></tr>";
                                }
                            ?>
                            </table>
                        </div>
                        ...
                        <?php
                            ...
                            while ($row_servicos = $result_servicos->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                "<tr>
                                    ...
                                    echo 
                                    "<td class='table_content'><a href=../edita/edita_serv.php?id=$id>
                                    <button type = 'button' class= 'btn btn-sm btn-success'>Editar</button></a></td>";
            
                                    echo "<td class='table_content'><a href='../deleta/deleta_serv.php?id=".$id."'data-confirm='tem certeza que deseha apagar?'><button type = 'button'  class= 'btn btn-sm btn-danger'>Excluir</button></a></td></tr>";
                            }
                        ?>
                        </table>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                        ...
                        <form method="POST" action="../valida/valida_serv_prest.php" enctype="multipart/form-data">
            ...
            <!-- teste -->
            <!--Modal 8-->
            <!-- <div class="modal fade" id="ModalCad8" tabindex="-1" role="dialog" aria-labelledby="ModalCad8" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="ModalCad8">Verificar Pedidos</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                <div class="center">
                                <h1 class="titulo">Lista de Pedidos</h1><br> 
                                ...
                                <!-- <div class="listar_pets">
                                    <table class="table_servs table-bordere-dark"> <!--Tabela HTML-->
                                        <!-- <tr> <!--Cria uma linha de uma tabela-->
                                            <!-- <td class="table-cel">ID</td><!--Cria uma coluna em uma linha-->
                                            <!-- <td class="table-cel">ID do Serviço</td>
                                            <td class="table-cel">ID do Pet</td>
                                            <td class="table-cel">ID do Usuário</td>
                                            <td class="table-cel">ID do Preço</td>
                                            <td class="table-cel">Criação</td>
                                            <td class="table-cel">Modificação</td>
                                            <td class="table-cel-btex">Edição</td>
                                            <td class="table-cel-bted">Exclusão</td>
                                    ...
                                    <?php
                                        // echo "<option value=''></option>";
                                        // while($row_prst_serv = $result_prst_serv->fetch(PDO::FETCH_ASSOC)){
                                        //     extract($row_prst_serv);
                                        //     echo 
                                        //     "<tr>
                                        //         <td class='table_content'>$id </td>
                                        //         <td class='table_content'>$servico_id </td>
                                        ...
                                        //         };
                                        //         echo 
                                        //         "<td class='table_content'><a href=../edita/edita_serv_prest.php?id=$id>
                                        //         <button type = 'button' class= 'btn btn-sm btn-success'>Editar</button></a></td>";
                        
                                        //         echo "<td class='table_content'><a href='../deleta/deleta_serv_prest.php?id=".$id."'data-confirm='tem certeza que deseja apagar?'><button type = 'button'  class= 'btn btn-sm btn-danger'>Excluir</button></a></td></tr>";
                                        // }
                                    ?>
                                    <!-- </table>
                                </div>
