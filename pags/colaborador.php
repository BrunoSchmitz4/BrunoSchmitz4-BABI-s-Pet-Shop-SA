...
// $query_serv_pres = "SELECT id, servico_id, pet_id, usuario_id, preco_id, created, modified FROM servicos_prestados ORDER BY id ASC";
...
<head>
    ...
    <title>Espaço Colaborador</title>
    ...
    <div>
        <header class="cabecalho">
            ...
            <nav class="cabecalho_menu"> 
                ...
                <div class="cl-log">
                    <?php
                        //Desloga o usuário e não permite voltar para a página logada
                ...
                <a class="cabecalho_menu_item" href="../pags/cliente_loggout.php">Encerrar Sessão</a>
            </nav>
        </header>
                        ...
                        <div class="modal-content">
                            ...
                            <?php
                                ...
                                while ($row_servicos = $result_servicos->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo "<ul>
                                    <li>ID: $id</li><br>
                                    <li>Tipo de serviço: $tipo_servico</li><br>
                        ...
                        <div class="modal-content"> <!--DIV 3-->
                            ...
                            <div class="modal-body"><!--DIV 4-->
                                <div class="center"><!--DIV 6-->
                                    ...
                                    ?>
                                    <option value="1" type=”hidden”>Cliente</option>
                                    </select>
