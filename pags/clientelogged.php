...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="cabecalho_menu">
            ...
            <a class="cabecalho_menu_item" href="../index.php">Sair</a>
        </nav>
    </header>
    <main class="conteudo">
            ...
            <h3 class="conteudo_secundario_titulo">O que podemos fazer pelo seu pet?</h3>
                <?php
                    ...
                    while ($row_servicos = $result_servicos->fetch(PDO::FETCH_ASSOC)){
                        ...
                        echo "
                        <p class='conteudo_secundario_paragrafo'>$id. <strong>$tipo_servico</strong></p><br>
                        <span class='conteudo_secundario_paragrafo_span'>$descricao</span>
                        <img width='450px' height='250' src='../css/imgs/$id/$imagem' alt='Imagem do serviço: $tipo_servico' class='conteudo_secundario_paragrafo_img'><br><br>
                        ";
                    }
                ?>
